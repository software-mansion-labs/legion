...
- Add `Legion.Sandbox.Lua` - agents write Lua evaluated by [luerl](https://github.com/rvirding/luerl), a Lua VM in pure Erlang. Generated code cannot reach the host BEAM at all (no AST allowlist to escape); tools are bridged in as global Lua tables with values converted at the boundary
